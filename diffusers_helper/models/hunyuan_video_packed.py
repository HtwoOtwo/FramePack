...
class HunyuanAttnProcessorFlashAttnDouble:
    def __call__(
        ...
        # NOTE hidden_states B, ?, 3072; encoder_hidden_states B, ?, 3072
...
class HunyuanVideoTransformer3DModelPacked(
    ...
    def process_input_hidden_states(
        ...
        if clean_latents is not None and clean_latent_indices is not None:
            ...
            # DynamicSwap_Conv3d(16, 3072, kernel_size=(1, 2, 2), stride=(1, 2, 2))
            # downsample T, H/2, W/2
        ...
        if clean_latents_2x is not None and clean_latent_2x_indices is not None:
            ...
            # DynamicSwap_Conv3d(16, 3072, kernel_size=(2, 4, 4), stride=(2, 4, 4))
            # downsample T/2, H/4, W/4
        ...
        if clean_latents_4x is not None and clean_latent_4x_indices is not None:
            ...
            # DynamicSwap_Conv3d(16, 3072, kernel_size=(4, 8, 8), stride=(4, 8, 8))
            # downsample T/4, H/8, W/8
    ...
    def forward(
        ...
        hidden_states = hidden_states[
            :, -original_context_length:, :
        ]  # NOTE 返回固定长度，不管concat了多少额外信息，做了多少attention，总是返回固定长度
